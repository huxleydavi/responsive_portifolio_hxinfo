...
--
-- Host: 127.0.0.1
-- Tempo de geração: 03-Jan-2023 às 21:11
...
(67, '::1', '2023-01-03 17:06:14', '63b42c63029db');
...
CREATE TABLE `tb_chamada.config` (
  ...
  `corbotaohover` varchar(255) NOT NULL
...
INSERT INTO `tb_chamada.config` (`img1`, `img2`, `img3`, `titulo`, `sub_titulo`, `botao`, `corbotao`, `corbotaohover`) VALUES
('1', '2', '3', ' Hx Info, a melhor agência de tecnologia.', 'Criamos sistemas profissionais para turbinar o seu negócio!', ' Saiba mais', '#1a1919', ''),
('1', '2', '3', ' Hx Info, a melhor agência de tecnologia.', 'Criamos sistemas profissionais para turbinar o seu negócio!', ' Saiba mais', '#1a1919', '');
...
('Hx Info Portifólio', 'Huxley Davi', 'Huxley Davi\', \'Me chamo Huxley, tenho 17 anos, nasci em Caratinga/MG, sou desenvolvedor e programador web, onde crio websites e sistemas profissionais para empresas, mini-negócios, lojas etc. Full-Satck Developer, onde faço a parte visual e também a parte de integração com sistemas de fácil entendimento e amigável ao usuário com o intuito de facilitar seu acesso ao sistema.\r\nCEO da HS Corporation, onde somos uma empresa no ramo de tecnologia que atua em difertentes áreas, de formatção de computadores até criação de aplicativos altamnete requisitado no mercado.\r\nCriador da Hyrms Agência de Plubicidade, que trabalha na parte de divulgação, tráfego pago, métricas, para faciltar o acesso ao website e divulgação do próprio. Criação de layouts, designs, portifólios entre diversas tarefas.', 'fa fa-sitemap', 'Criação de websites profissionais, totalmente responsivo funcionando tanto em computador como mobile.', 'fa fa-user', 'Design de imagens, artes para publicidade, design de apps, layouts, sistemas.', 'fa fa-rocket', 'Sistemas autônomo, 100% amigável ao usuário e administrador, com painel e interface amigável para edição e controle do sistema.');
