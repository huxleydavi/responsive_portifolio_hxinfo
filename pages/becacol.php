...
<body>
    ...
    <section class="home">
        <div class="container">
            <div class="title">
                <h2><x>Beca</x> <z>Collection.</z></h2>
                <p>Divulgação de Loja Online</p>
            </div>
            <div class="homeimg">
                <img src="images/becacol.jpg" />
            </div>
            <div class="homefooter">
                ...
                <div class="homefooterbotao">
                    <a href="https://api.whatsapp.com/send/?phone=15058000945&text=Olá%2C+poderia+me+ajudar%3F&type=phone_number&app_absent=0" target="_blank"><button>Iniciar projeto.</button></a>
                </div>
            </div>
        </div>
    </section>
